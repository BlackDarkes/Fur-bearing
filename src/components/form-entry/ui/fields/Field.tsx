...
export const Field = ({ register, isFocus, setIsFocus }: IFieldProps) => {
  return (
    <input
      ...
      className={cn(
        `w-full py-2.5 px-4 bg-transparent text-primary-color placeholder:text-placeholder-color outline-none border border-transparent border-b-placeholder-color transition-all ease-in duration-300
