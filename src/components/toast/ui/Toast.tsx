...
export const Toast = () => {
  const { isOpen, message, handleClose, setMessage } = useToastStore();

  return (
    <section className={cn(
      `fixed right-5 bottom-5 w-[clamp(300px,100vw,500px)] h-20 bg-header-bg rounded-[8px_8px_20px_8px] shadow-block-shadow -translate-y-full transition duration-500 ease-in z-500`,
